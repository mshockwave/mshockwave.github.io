...
*/
import '../../node_modules/@polymer/app-layout/app-scroll-effects/app-scroll-effects-behavior.js';

import { registerEffect } from '../../node_modules/@polymer/app-layout/helpers/helpers.js';
 ...
 * position.
 */
registerEffect('vertical-resize-title', {
  ...
  setUp: function setUp() {
    ...
    condensedTitle.style.webkitTransformOrigin = 'top';
    condensedTitle.style.transformOrigin = 'top';

    title.style.willChange = 'opacity';
    title.style.webkitTransformOrigin = 'top';
