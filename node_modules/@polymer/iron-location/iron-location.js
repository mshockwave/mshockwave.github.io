 ...
 */(0,_polymerFn.Polymer)({is:"iron-location",_template:null,properties:{/**
...
// in a new tab.
if(event.metaKey||event.ctrlKey||event.shiftKey){return null}for(var eventPath=(0,_polymerDom.dom)(event).path,anchor=null,i=0,element;i<eventPath.length;i++){element=eventPath[i];if("A"===element.tagName&&element.href){anchor=element;break}}// If there's no link there's nothing to do.
