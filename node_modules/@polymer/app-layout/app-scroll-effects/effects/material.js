 ...
 */(0,_helpers.registerEffect)("material",{/** @this {Material} */setUp:function setUp(){this.effects="waterfall resize-title blend-background parallax-background";return!1}});/**
 * @interface
 * @extends {ElementWithBackground}
 */class Material{constructor(){/** @type {string} */this.effects}}});