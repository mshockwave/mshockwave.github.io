 ...
 */(0,_helpers.registerEffect)("waterfall",{/** @this {Waterfall} */run:function run(){this.shadow=this.isOnScreen()&&this.isContentBelow()}});/**
 * @interface
 * @extends {ElementWithBackground}
 */class Waterfall{constructor(){/** @type {boolean} */this.shadow}}});