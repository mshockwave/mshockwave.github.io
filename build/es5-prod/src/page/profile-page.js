...
// align setting is ok.
if(0>diff||0===diff&&(vAlignOk||hAlignOk)){position=candidate}}return position}};_exports.IronFitBehavior=IronFitBehavior;var ironFitBehavior={IronFitBehavior:IronFitBehavior};_exports.$ironFitBehavior=ironFitBehavior;var template=(0,_landingPage.html$1)(_templateObject_62df2110b4d411edb153593493d7efb1());document.head.appendChild(template.content);var p=Element.prototype,matches=p.matches||p.matchesSelector||p.mozMatchesSelector||p.msMatchesSelector||p.oMatchesSelector||p.webkitMatchesSelector,IronFocusablesHelperClass=/*#__PURE__*/function(){function IronFocusablesHelperClass(){babelHelpers.classCallCheck(this,IronFocusablesHelperClass)}babelHelpers.createClass(IronFocusablesHelperClass,[{key:"getTabbableNodes",/**
...
// e.g. in Firefox `<div contenteditable>` has `tabIndex = -1`
var ati=Math.max(a.tabIndex,0),bti=Math.max(b.tabIndex,0);return 0===ati||0===bti?bti>ati:ati>bti}}]);return IronFocusablesHelperClass}(),IronFocusablesHelper=new IronFocusablesHelperClass;_exports.IronFocusablesHelper=IronFocusablesHelper;var ironFocusablesHelper={IronFocusablesHelper:IronFocusablesHelper};_exports.$ironFocusablesHelper=ironFocusablesHelper;(0,_landingPage.Polymer)({/** @override */_template:(0,_landingPage.html$1)(_templateObject2_62df2110b4d411edb153593493d7efb1()),is:"iron-overlay-backdrop",properties:{/**
...
if(this.hasRipple()&&1>this.getRipple().ripples.length){this._ripple.uiDownAction()}},/**
   ...
   *
   * @param {!KeyboardEvent} event .
   */_spaceKeyUpHandler:function _spaceKeyUpHandler(event){_landingPage.IronButtonStateImpl._spaceKeyUpHandler.call(this,event);if(this.hasRipple()){this._ripple.uiUpAction()}}};/** @polymerBehavior */_exports.PaperButtonBehaviorImpl=PaperButtonBehaviorImpl;var PaperButtonBehavior=[_landingPage.IronButtonState,_landingPage.IronControlState,_landingPage.PaperRippleBehavior,PaperButtonBehaviorImpl];_exports.PaperButtonBehavior=PaperButtonBehavior;var paperButtonBehavior={PaperButtonBehaviorImpl:PaperButtonBehaviorImpl,PaperButtonBehavior:PaperButtonBehavior};_exports.$paperButtonBehavior=paperButtonBehavior;var template$1=(0,_landingPage.html)(_templateObject3_62df2110b4d411edb153593493d7efb1());template$1.setAttribute("strip-whitespace","");/**
                                                 Material design:
